...
#define crypto_sign_signature_faulty DILITHIUM_NAMESPACE(signature_faulty)
int crypto_sign_signature_faulty(uint8_t *sig, size_t *siglen,
                          const uint8_t *m, size_t mlen,
                          const uint8_t *sk, const size_t row, const size_t cff);
